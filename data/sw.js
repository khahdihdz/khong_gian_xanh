...
// Cache shell có version; API/WebSocket/OTA luôn đi thẳng tới thiết bị.
const CACHE_NAME = 'kgx-shell-v3';
const SHELL_FILES = ['/', '/index.html', '/tools.html', '/wifi_config.html', '/manifest.json', '/icons/icon-192.png', '/icons/icon-512.png'];
